...
const StudentTable: React.FC = () => {
  ...
  const paginatedStudents = filteredStudents.slice(0, visibleRows);
  ...
  return (
    <div className="p-6 bg-white min-h-screen rounded-lg shadow">
      ...
      <div className="overflow-x-auto shadow-lg rounded-lg">
        ...
        {/* Show more / less */}
        {!loading && filteredStudents.length > visibleRows && (
          <div className="mt-4 flex justify-center">
            <button onClick={() => setVisibleRows(prev => prev + 10)} className="px-4 py-2 bg-white border rounded">عرض المزيد ({filteredStudents.length - visibleRows} متبقي)</button>
          </div>
        )}
